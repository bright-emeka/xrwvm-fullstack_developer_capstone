...
// Show logout if logged in, otherwise show Login and Register links
if (curr_user !== null && curr_user !== "") {
    ...
    home_page_items = (
      <div className="input_panel">
        <a className="nav_item" href="/login" style={{paddingRight: "10px", color: "black", textDecoration: "none"}}>Login</a>
        <a className="nav_item" href="/register" style={{color: "black", textDecoration: "none"}}>Register</a>
      </div>
    );
}
